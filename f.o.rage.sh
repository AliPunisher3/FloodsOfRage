...
function banner(){                                                  
echo -e ${lb}"
 _____ _     ___   ___  ____  ____     ___  _____   ____      _    ____ _____ 
|  ___| |   / _ \ / _ \|  _ \/ ___|   / _ \|  ___| |  _ \    / \  / ___| ____|
| |_  | |  | | | | | | | | | \___ \  | | | | |_    | |_) |  / _ \| |  _|  _|  
|  _| | |__| |_| | |_| | |_| |___) | | |_| |  _|   |  _ <  / ___ \ |_| | |___ 
|_|   |_____\___/ \___/|____/|____/   \___/|_|     |_| \_\/_/   \_\____|_____|
                                                                               "
echo -e ${CNC}"      Sometimes, The Only Way To Save A Live, Is To Take One.              "
echo -e ${NEW}"               An Exploit Workbench For Exploading OS                        "
echo -e ${CP}"               Exploit By :  ${CP}Ali Punisher                          "
echo -e ${CP}"               Find Me:  ${RED}Instagram: Ali_Punisher3                                 "
echo -e ${YELLOW}"               Punish The SystemS                                              "
echo -e ${GREEN}"################################################################################\n"
...
echo -e -n ${BLUE}"\nAli_Punisher3@Exploit:~/LHOST# "
read lhost
echo -e -n ${NC}"\nAli_Punisher3@Exploit:~/LPORT# "
read lport
...
clear
banner
echo -e "\n${NC}[${CG}"*"${NC}]${CNC} Welcome! Choose One To Start Of War \n"
echo -e "${NC}[${CG}"1"${NC}]${BLUE} Linux Os "
echo -e "${NC}[${CG}"2"${NC}]${BLUE} Windows Os"
echo -e "${NC}[${CG}"3"${NC}]${BLUE} MacOS Punish "
echo -e "${NC}[${CG}"4"${NC}]${BLUE} Android Punish"
echo -e "${NC}[${CG}"5"${NC}]${BLUE} IOS Punish"
echo -e "${NC}[${CG}"6"${NC}]${RED} Bypass Android Security (Coming Soon)"
echo -e "${NC}[${CG}"7"${NC}]${RED} Camera Live Android (Coming Soon) "
echo -e "${NC}[${CG}"8"${NC}]${RED} Root Android  Not Support Old Android (Coming Soon)"
echo -e "${NC}[${CG}"9"${NC}]${CNC} See U In Hell "
echo -n -e ${CPO}"\n[+] Select: "
read play
   if [ $play -eq 1 ]; then
          linux
...
menu
#I’ve learned from experience that the place to save lives is in the field, not an office. And sometimes, the only way to save a live, Is to take one.
